...
The training set consists of time series information for twelve subjects performing 8 series of GAL tasks.  We are provided with a data file consisting of the EEG recordings from the 32 electrodes.  
%A corresponding events file describes the event corresponding to the data file.\\
...
\begin{thebibliography}{1}
  ...
  \bibitem{baselineSoftware} https://github.com/alexandrebarachant/Grasp-and-lift-EEG-challenge/tree/master/lvl1
  \bibitem{hardwarespecifications} https://github.com/alexandrebarachant/Grasp-and-lift-EEG-challenge\#hardware
\end{thebibliography} 
